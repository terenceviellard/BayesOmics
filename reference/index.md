...
- [`print(`*`<group_diff_result>`*`)`](https://terenceviellard.github.io/BayesOmics/reference/print.group_diff_result.md)
  : Print a Group-Difference Result
