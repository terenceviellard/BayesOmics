...
ratio, retention time, â€¦) to capture correlation structure, fits that kernel by
...
but share a meaningful ordering or distance along some axis â€” genomic position,
