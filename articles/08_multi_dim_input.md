# Input with more than one dimension
...
![](08_multi_dim_input_files/figure-html/unnamed-chunk-3-1.png)
...
pattern](08_multi_dim_input_files/figure-html/unnamed-chunk-5-1.png)
...
*Basic pipeline* – *Using a kernel other than SE*.
